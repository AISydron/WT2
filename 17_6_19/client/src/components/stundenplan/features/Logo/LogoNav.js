...
export class LogoNav extends Component {
    ...
    render() {
        return (
            <div>
                <div id="kairos" class='spot'><img src={kairos} alt='LOGO' onClick={this.handleClick}/></div>    
                <div class='spotHighlight' onClick={this.handleClick}><p><b>Your EZ' better study Planner</b></p></div>           
            </div>
        )
    }
}
